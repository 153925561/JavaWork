	...
	<div class="header">
		...
		<div class="content">
			...
			<div class="right">
				...
				<form action="updateStudent" method="post"  name="form1" >
					
					<table border="0" cellspacing="5" cellpadding="2">							
						<tr>
							<input type="text" name="id" value="${student.stuid}"  style="display: none"></td>
							<td><span>*</span>姓名:</td>
							<td><input type="text" name="name" value="${student.stuname}"/></td>
						</tr>								
						<tr>
							<td><span>*</span>用户名:</td>
							<td><input type="text" name="username" value="${student.stuusername}"/></td>
						</tr>
						<tr>
							<td><span>*</span>密码:</td>
							<td><input type="text" name="password1"  value="${student.stupassword}"/></td>
						</tr>
						<tr>
							<td><span>*</span>重复密码:</td>
							<td><input type="text" name="password2"  value="${student.stupassword}"/></td>
						</tr>						
						<tr>
							<td><span>*</span>性别:</td>
							<td><input type="text" name="sex"  value="${student.stusex}"/></td>
						<tr>
							<td><span>*</span>班级:</td>
							<td><input type="text" name="cls" value="${student.stuclass}" /></td>
						</tr>						
						<tr>
							<td></td>
							<td>
								<input type="submit" name="choose" value="修改学生" >
