...
<link rel="stylesheet" type="text/css" href="resources/css/addBuilding.css"/>
</head>
<body>
	<div class="header">
			<div class="title">
			...
			<div class="right">
				...
				<form action="" method="get" >
					<table border="0" cellspacing="5" cellpadding="2">						
						...
						<tr>
							<td><span>*</span>楼宇管理员:</td>
							<td><input type="text" name="b_teacher" id="b_teacher" value="" /></td>
						</tr>
						<tr>
							<td></td>
							<td>
								<input type="submit" name="choose" value="添加楼宇"  >
