	...
	<div class="header">
		...
		<div class="content">
			...
			<div class="right">
				...
				<form action="updateRoom" method="post" name="form1" >
					
					<table border="0" cellspacing="5" cellpadding="2">
						<tr>
							<input type="text" name="id" value="${room.roomid}"  style="display: none"></td>
							<td><span>*</span>楼宇:</td>
							<td><input type="text" name="build" value="${room.roombuilding}"  /></td>
						</tr>								
						<tr>
							<td><span>*</span>寝室号:</td>
							<td><input type="text" name="name" value="${room.roomnumber}" /></td>
						</tr>
						<tr>
							<td><span>*</span>寝室人数:</td>
							<td><input type="text" name="people" value="${room.roompeople}" /></td>
						</tr>
						<tr>
							<td><span>*</span>寝室电话:</td>
							<td><input type="text" name="tel" value="${room.roomphone}"  /></td>
						</tr>
						
						<tr>
							<td></td>
							<td>
								<input type="submit" name="choose" value="修改宿舍" >
