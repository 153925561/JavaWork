	...
	<div class="header">
		...
		<div class="content">
			...
			<div class="right">
				...
				<form action="AddaTeacher" method="post" name="form1">
					<table border="0" cellspacing="5" cellpadding="2">					
						<tr>
							<td><span>*</span>用户名:</td>
							<td><input type="text" name="username" id="username" value="" onblur="ajaxGet()" /></td>
						...
						<tr>
							<td></td>
							<td>
								<input type="submit" name="choose" value="添加楼宇管理员">
